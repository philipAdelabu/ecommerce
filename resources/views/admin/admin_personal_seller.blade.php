                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h3>Administrator: {{ $admin->name }}.</h3>
                                    <h5>Under-line Sellers:</h5>
                                    @include('inc.message')
                                </div>
                            </div>
                                    ...
                                    <table class="table table-responsive table-bordered" id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" 
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="name" data-editable="false">Name<div class="text-center"></div></th>
                                                <th data-field="email" >Company</th>
                                                <th data-field="price" ><div class="text-center">State</div></th>
												<th data-field="date" >City</th>
                                        ...
                                        @if($sellers)
                                          @php $count = 1 ; @endphp
                                           ...
                                           <td >
                                           &nbsp;&nbsp;
                                           <a href="{{ url('admin/supplier/view', ['id'=>$t->id]) }}" class="btn btn-xs btn-primary" >View</a>
                                           &nbsp;&nbsp;
                                               @if($t->status == 0)  
                                               <a href="{{ url('admin/user', ['status'=>'suspend', 'id'=>$t->id]) }}" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure about this ?');">Suspend</a>&nbsp;&nbsp;
                                               @else
