...
<h3>Shipping Policy Description</h3>
...
<div class="span1"></div>
<div class="span10">
{{ Form::open(['url'=>'admin/update/shipping', 'role'=>'form', ]) }}
     {{ csrf_field() }}
  <fieldset>
           ...
           <!-- Beginning of the editor content -->
            <section class="content">
                  ...
                  <div class="col-md-12">
                    <div class="box box-info">
                      <div class="box-header">
                        <h3 class="box-title">Shipping Policy </h3>
                        <!-- tools box -->
                      ...
                      <textarea name="shipping" id="editor1" name="editor" rows="10" cols="80">
                        {{  $info->shipping ?? '' }}
                      </textarea>
                      </div>
                    </div>
              ...
              <!-- End of the Editor -->
              <button type="submit" class="btn btn-primary">Update Shipping Policy</button>
              <hr />
