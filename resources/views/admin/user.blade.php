                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h3>All Available Users of the system.</h3>
                                    @include('inc.message')
                                </div>
                            </div>
                                          ...
                                          @php $count = 1 ; @endphp
                                           ...
                                           <td >&nbsp;&nbsp;
                                            @if(session()->exists('admin_id') && session('admin_id') == 1)
                                              ...
                                              @endif
                                              <a href="{{ url('admin/user', ['status'=>'delete','id' => $t->id ]) }}" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure you want to do this ?');">Delete</a>
                                            @endif
                                           </td>
                                           </tr>
                                            @php $count++ ; @endphp
