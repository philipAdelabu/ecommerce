...
{{ Form::open(['url'=>'admin_add_news', 'files' => 'true', 'role'=>'form', 'enctype'=>'multipart/form-data']) }}
    ...
    <div class="control-group">
			...
			<div class="controls">
			  <input required name="title" type="text" class="input-xxlarge" id="title" value="{{ $content->title }}">
			</div>
   </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <textarea name="content" id="editor1" name="editor" rows="15" cols="80">
             {!! $content->message !!}
            </textarea>
            </div>
          </div>
   ...
   <br />
    <div class="control-group">
			...
			<div class="controls">
			  <input required name="author" type="text" class="input-xxlarge" id="author" value="{{ $content->author }}">
			</div>
   </div>
  <hr />
      ...
      @if($content->image)
      <div class="pull-right"> <img  height="150px" width="150px" src="{{ url($content->image) }}" alt="" /></div>
      @endif
          <div class="control-group">
          ...
          <input type="hidden" name="old_image" value="{{ $content->image  ? $content->image : '' }}" />
