...
<div class="span1"></div>
<div class="span10">
{{ Form::open(['url'=>'admin/update/terms', 'role'=>'form', ]) }}
     {{ csrf_field() }}
  <fieldset>
           ...
           <!-- Beginning of the editor content -->
            <section class="content">
                <div class="row">
                  <div class="col-md-12">
                    <div class="box box-info">
                      ...
                      <textarea name="terms" id="editor1" name="editor" rows="10" cols="80">
                        {{  $info->terms ?? '' }}
                      </textarea>
                      </div>
                    </div>
              ...
              <!-- End of the Editor -->
              <button type="submit" class="btn btn-primary">Update T&C</button>
              <hr />
