                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center"  style="color: #fff; float: right">
                                <h2 class="bradcaump-title"  style="color: #fff;">404 Error</h2>
                                <nav class="bradcaump-inner">
                                  <a class="breadcrumb-item" style="color: #fff;" href="{{ url('/') }}">Home</a>
                                  <span class="brd-separetor">/</span>
                                  <span style="color: #fff;" class="breadcrumb-item active">We could not find what you were looking for</span>
                                </nav>
                            </div>
                        </div>
                    </div>
